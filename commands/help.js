  ...
  run: async (client, interaction) => {
    try {
      ...
      const button1 = new ButtonBuilder()
        .setLabel('Invite Me!')
        .setURL('https://discord.com/api/oauth2/authorize?client_id=1202696328258519112&permissions=8&scope=bot+applications.commands')
        .setStyle(ButtonStyle.Link);

      const button2 = new ButtonBuilder()
        .setLabel('Support')
        .setURL('https://discord.gg/y8QrrCTnJB')
        .setStyle(ButtonStyle.Link);

      const button3 = new ButtonBuilder()
        .setLabel('official dc')
        .setURL('https://dsc.gg/heaven-mc')
        .setStyle(ButtonStyle.Link);
